...
-   For **web apps**, Google's `firebase/agent-skills` bundle adds JavaScript
    client SDK guides. This bundle is **opt-in** in this environment — see the
    "Extension" section of `firebase-basics/SKILL.md` before installing.
    Install with:
